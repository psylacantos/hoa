 ...
 * @author eabiii
 */
@WebServlet(name = "viewMonthly", urlPatterns = {"/viewMonthly"})
public class viewMonthly extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
        for(TrxReferences tr:TransactionDao.getTransactionReferencesById(id)){
                    transact=tr;
                    System.out.println(transact.getAmount());
               ...
               // request.setAttribute("bill", bill);
                ...
                request.getRequestDispatcher("viewmonthly.jsp").forward(request, response);
         }
